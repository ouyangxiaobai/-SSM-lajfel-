...
<style>
body{background: #fff url(<%=basePath%>shouye/muban5/images/index.jpg) 50% 0 no-repeat;margin:0;padding:0;}
...
#login .logo{height:78px; text-align:center; font-size:30px; font-weight:bold; color:black; margin-top:40px;}
...
#login .main form ul li .bnt{width:292px;border:0;background:black;color:#fff;border-radius:4px;padding:12px 0;margin:0;font-size:16px;font-family:microsoft yahei;cursor:pointer;}
